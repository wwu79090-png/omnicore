...
async function main() {
  ...
  const report = [
    ...
    '- Public namespace objects retained for compatibility: Addons, Backend, Core, DB, Easing, Font, Geom, GlobalHook, License, Physics, Plugin, Pool, Query, RendererContract, Shape, Task, Transform2D',
    '',
    '## Findings',
    '',
